...
$lang = [
  ...
  'sh'	=> [
	...
	'hr'	=> [
		'thank_you'					=> 'HVALA!',
		'your_order_received'		=> 'Vaša narudžba je zaprimljena!',
		'not_turn_phone'			=> 'Molimo vas da ne isključujete svoj mobilni telefon!',
		'order_received'			=> 'Narudžba zaprimljena',
		'purchase_finalized'		=> 'Kupovina završena',
		'delivered_paid'			=> 'Isporučeno i plaćeno',
		'text_purchase_finalized'	=> 'Željeli bismo vas kontaktirati telefonom kako bismo finalizirali vašu kupovinu. Ovo je vrlo važno jer ćemo vam na taj način moći pružiti sve potrebne informacije i odgovoriti na sva pitanja koja možda imate.',
		'form_order_information'	=> 'Informacije o narudžbi',
		'form_order_number'			=> 'Broj narudžbe:',
		'form_name'					=> 'Ime:',
		'form_date'					=> 'Datum:',
		'form_phone'				=> 'Telefon:',
		...
		'contest'					=> 'NAGRADNA IGRA',
		'Want_to_get_an_iphone'		=> 'Želite li osvojiti iPhone 15 Pro?',
		'buy_packs_noemail'			=> 'Sve što trebate učiniti je kupiti puni tretman, tj. 3 paketa proizvoda i možete osvojiti jedan od 30 iPhone 15 Pro!',
		'your_email'				=> 'Vaša email adresa',
		'participate'				=> 'Sudjelujte',
		'hurry_up'					=> 'POŽURITE',
		'the_draw_just'				=> 'Izvlačenje je za samo 2 tjedna!',
	],
	'sq'	=> [
	...
	'it'	=> [
		...
		'not_turn_phone'			=> 'Per favore, non spegnere il cellulare!',
		'order_received'			=> 'Ordine ricevuto',
		'purchase_finalized'		=> 'Acquisto finalizzato',
		'delivered_paid'			=> 'Consegnato e pagato',
		'text_purchase_finalized'	=> 'Vorremmo contattarti telefonicamente per finalizzare il tuo acquisto. Questo è molto importante, perché in questo modo potremo fornirti tutte le informazioni necessarie e rispondere a qualsiasi domanda tu possa avere.',
		'form_order_information'	=> 'Informazioni sull\'ordine',
		'form_order_number'			=> 'Numero ordine:',
		'form_name'					=> 'Nome:',
		'form_date'					=> 'Data:',
		'form_phone'				=> 'Telefono:',
		'products'					=> 'Prodotti:',
		'icon_result'				=> 'Garanzia di risultato o rimborso entro 365 giorni',
		'icon_effectiveness'		=> 'La sicurezza e l\'efficacia del prodotto sono clinicamente provate',
		'contest'					=> 'CONCORSO',
		'Want_to_get_an_iphone'		=> 'Vuoi vincere un iPhone 15 Pro?',
		'buy_packs_noemail'			=> 'Tutto quello che devi fare è acquistare un trattamento completo, cioè 3 confezioni del prodotto, e potresti vincere uno dei 30 iPhone 15 Pro!',
		'your_email'				=> 'La tua email',
		'participate'				=> 'Partecipa',
		'hurry_up'					=> 'AFFRETTATI',
		'the_draw_just'				=> 'l\'estrazione è tra sole 2 settimane!'
	],
	'id'	=> [
		'thank_you'					=> 'TERIMA KASIH!',
		'your_order_received'		=> 'Pesanan Anda telah diterima!',
...
<div class="t7"> Cardio Tonus   
  <span>
    <s> 4000 PHP </s> | <b> 1950 PHP </b>
  </span>
</div>
<div class="t8">
